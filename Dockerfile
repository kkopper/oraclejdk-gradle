...
RUN wget -q https://services.gradle.org/distributions/gradle-4.3-bin.zip
RUN mkdir -p /opt/gradle
RUN unzip -q -d /opt/gradle gradle-4.3-bin.zip
RUN rm gradle-4.3-bin.zip

ENV JAVA_HOME "/jdk1.8.0_144"
ENV PATH "${PATH}:${JAVA_HOME}/bin:/opt/gradle/gradle-4.3/bin"
